export const largeCardSections = [
  {
    id: 1,
    title: "Top rated fire extinguisher in Australia!",
    snippet: "If you need an extinguisher to rent if your place is burning down, get one of these mate!",
    cards: [
      {
        id: 19,
...
export const smallCardSections = [
    {
        id: 1,
        title: "Fire Extinguisher in New Zealand",
        cards: [
            {
              id: 1,
              image: "fe7.jpg"
    ...
    {
      id: 2,
      title: "Fire Extinguisher in Australia",
      cards: [
          {
            id: 13,
            image: "fe19.jpg"
